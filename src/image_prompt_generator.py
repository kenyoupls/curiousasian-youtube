...
Images are generated by Cloudflare FLUX Schnell. A LOCKED style template wraps your scene description:
"flat 2D cartoon illustration, thick black outlines, solid flat colors, simple minimalist style like OverSimplified YouTube channel, [YOUR SCENE DESCRIPTION], clean composition, no gradients, no shading, no photorealism"
